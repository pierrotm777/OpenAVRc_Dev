...
//... Check definitions above and use HMC5883 mag by default
  ...
  #undef SENSOR_QMC5883
    ...
    #undef SENSOR_HMC5883
  #else
    #define SENSOR_NAME "HMC5883"// GY-85 utilise un HMC5883
...
#define BLUETOOTH_SERIAL_BAUD 115200  //57600 appears to be max for SoftwareSerial, otherwise 115200 OK, set equal to SERIAL_BAUD if you want to have automatic bt communication off when hooked up to GUI
